...
# ???
RUN cd /tmp && wget https://raw.githubusercontent.com/ublue-os/bazzite/refs/heads/main/build_files/install-nvidia && chmod +x ./install-nvidia && export BASE_IMAGE_NAME=kinoite sh && ./install-nvidia
